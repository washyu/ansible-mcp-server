...
describe('security-check-ssh', () => {
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-check-ssh', {
  ...
  // TODO: Add more specific tests for security-check-ssh
  // - Edge cases
