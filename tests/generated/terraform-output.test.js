...
describe('terraform-output', () => {
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'terraform-output', {
  ...
  it('should fail when missing required parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'terraform-output', {
      // Missing required params: directory, json
    });
  ...
  it('should validate parameter types', async () => {
    const result = await global.testUtils.callMCPTool(server, 'terraform-output', {
      ...
      json: 'invalid', // Should be boolean
    });
  ...
  // TODO: Add more specific tests for terraform-output
  // - Edge cases
