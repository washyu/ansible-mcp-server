...
describe('security-audit-accounts', () => {
  let server;
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-audit-accounts', {
      checkSudo: true,
      checkDefaults: true
    });
  ...
  it.skip('should fail when missing required parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-audit-accounts', {
      // Missing required params: checkSudo, checkDefaults
    });
  ...
  it.skip('should validate parameter types', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-audit-accounts', {
      checkSudo: 'invalid', // Should be boolean
      checkDefaults: 'invalid', // Should be boolean
    });
  ...
  // TODO: Add more specific tests for security-audit-accounts
  // - Edge cases
