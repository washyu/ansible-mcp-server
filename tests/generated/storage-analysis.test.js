...
describe('storage-analysis', () => {
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'storage-analysis', {
      target: 'localhost',
  ...
  it.skip('should fail when missing required parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'storage-analysis', {
      // Missing required params: target, includePartitions, includeSmartData
    });
  ...
  it.skip('should validate parameter types', async () => {
    const result = await global.testUtils.callMCPTool(server, 'storage-analysis', {
      ...
      includePartitions: 'invalid', // Should be boolean
      includeSmartData: 'invalid', // Should be boolean
    });
  ...
  // TODO: Add more specific tests for storage-analysis
  // - Edge cases
