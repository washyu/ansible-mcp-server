...
describe('ansible-role', () => {
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'ansible-role', {
      role: 'test-string',
      hosts: 'localhost',
  ...
  it('should fail when missing required parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'ansible-role', {
      // Missing required params: role, hosts, inventory, become, extraVars, check, verbose
    });
  ...
  // TODO: Add more specific tests for ansible-role
  // - Edge cases
