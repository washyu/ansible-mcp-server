...
describe('discover-network-devices', () => {
  let server;
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'discover-network-devices', {
      subnet: 'test-string',
      knownDevices: []
    });
  ...
  it.skip('should fail when missing required parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'discover-network-devices', {
      // Missing required params: subnet, knownDevices
    });
  ...
  it('should validate parameter types', async () => {
    const result = await global.testUtils.callMCPTool(server, 'discover-network-devices', {
      ...
      knownDevices: 'invalid', // Should be array
    });
  ...
  // TODO: Add more specific tests for discover-network-devices
  // - Edge cases
