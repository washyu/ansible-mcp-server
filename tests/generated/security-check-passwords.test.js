...
describe('security-check-passwords', () => {
  let server;
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-check-passwords', {
      checkPolicy: true
    });
  ...
  it('should fail when missing required parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-check-passwords', {
      // Missing required params: checkPolicy
    });
  ...
  it('should validate parameter types', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-check-passwords', {
      checkPolicy: 'invalid', // Should be boolean
    });
  ...
  // TODO: Add more specific tests for security-check-passwords
  // - Edge cases
