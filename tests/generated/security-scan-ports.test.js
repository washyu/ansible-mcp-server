...
describe('security-scan-ports', () => {
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-scan-ports', {
      targets: [],
      portRange: 8080
    });
  ...
  it('should fail when missing required parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-scan-ports', {
      // Missing required params: targets, portRange
    });
  ...
  it('should validate parameter types', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-scan-ports', {
      ...
      portRange: 123, // Should be string
    });
  ...
  // TODO: Add more specific tests for security-scan-ports
  // - Edge cases
