...
describe('security-check-updates', () => {
  let server;
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-check-updates', {
      checkCVE: true
    });
  ...
  it.skip('should fail when missing required parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-check-updates', {
      // Missing required params: checkCVE
    });
  ...
  it('should validate parameter types', async () => {
    const result = await global.testUtils.callMCPTool(server, 'security-check-updates', {
      checkCVE: 'invalid', // Should be boolean
    });
  ...
  // TODO: Add more specific tests for security-check-updates
  // - Edge cases
