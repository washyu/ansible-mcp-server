...
describe('remove-external-server', () => {
  let server;
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'remove-external-server', {
      name: 'test-name'
    });
  ...
  // TODO: Add more specific tests for remove-external-server
  // - Edge cases
