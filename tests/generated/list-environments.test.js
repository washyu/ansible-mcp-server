...
describe('list-environments', () => {
  ...
  it('should execute successfully with valid parameters', async () => {
    const result = await global.testUtils.callMCPTool(server, 'list-environments', {
    ...
    if (result.success) {
      ...
      expect(result.output.toLowerCase()).toMatch(/homelab/);
    }
  });
  ...
  // TODO: Add more specific tests for list-environments
  // - Edge cases
